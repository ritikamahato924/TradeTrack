    ...
    return ( 
        <>
            ...
            <RightSection
                ...
                simple HTTP/JSON APIs. If you are a startup, build your investment app and showcase it to our clientbase."
                learnMore="" 
                />
            ...
            <>
                <p className="text-center mt-4 mb-5" style={{fontSize:"20px"}}>Want to know more about our technology stack? Check out the <a href="" style={{textDecoration:"none"}}>Zerodha.tech</a> blog.</p>
            </>
            <Universe/>
        </>
     );
